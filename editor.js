...
function focusEditor(e)
{
  ...
  if(key === 73)
  {
    ...
    setTimeout(function(){ element.focus(); }, 1);//Put focus in editor's div element. Timing issues
...
function keyCatcher(e)
{
  ...
  {
    newChar = document.createTextNode(character);
    document.getElementById('1').appendChild(newChar);
  }
}
